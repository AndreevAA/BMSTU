...
def main():
    first_string = input("Input first_string: ")
    second_string = input("Input second_string: ")

    print(levenshtein.LevenshteinRecursiveWithCache(first_string, second_string).get_distance())
