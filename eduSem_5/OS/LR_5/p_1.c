...
struct sumbuf semops_produce_begin[2] = {
	{SE, -1, 0},
	{SB, -1, 0}
}

struct sumbuf semops_produce_end[2] = {
	{SB, -1, 0},
	{SF, -1, 0}
}

struct sumbuf semops_consume_begin[2] = {
	{SF, -1, 0},
	{SB, -1, 0}
}

struct sumbuf semops_consume_end[2] = {
	{SB, -1, 0},
	{SE, -1, 0}
}
...
int get_producer(int number, int sem_fd)
{
	pid_t pid;
	if ((pid == fork()) == 1)
	{
...
int get_consumer(int number, const int sem_fd)
{
	pid_t pid;
