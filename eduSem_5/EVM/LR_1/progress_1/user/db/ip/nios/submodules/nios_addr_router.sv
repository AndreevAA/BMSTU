...
(
    ...
    localparam PAD1 = log2ceil(32'h9000 - 32'h8800);
    localparam PAD2 = log2ceil(32'h9040 - 32'h9020);
    localparam PAD3 = log2ceil(32'h9050 - 32'h9048);
    ...
    always @* begin
        ...
        // ( 0x8800 .. 0x9000 )
        if ( {address[RG:PAD1],{PAD1{1'b0}}} == 'h8800 ) begin
            src_channel = 4'b0001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
        end

        // ( 0x9020 .. 0x9040 )
        if ( {address[RG:PAD2],{PAD2{1'b0}}} == 'h9020 ) begin
            src_channel = 4'b1000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
        end

        // ( 0x9048 .. 0x9050 )
        if ( {address[RG:PAD3],{PAD3{1'b0}}} == 'h9048 ) begin
            src_channel = 4'b0100;
