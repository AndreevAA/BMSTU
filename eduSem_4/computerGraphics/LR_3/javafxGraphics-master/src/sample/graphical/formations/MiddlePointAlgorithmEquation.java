...
public class MiddlePointAlgorithmEquation extends GraphicalObject {
    ...
    public MiddlePointAlgorithmEquation(double tempCenterX, double tempCenterY, double tempLeftRadious, double tempTopRadious, boolean isOval, Color tempColor)
    {
    ...
    public void draw(GraphicsContext context) {
        ...
        if (isOval == false)
        {
            ...
            for (int tempNumberOfLine = 0; tempNumberOfLine < numberOfPoints; tempNumberOfLine++)
            {
                ...
                context.strokeOval((int) tempData[0] + 1, (int) tempData[1] - 1/2, 1, 1);

                context.strokeOval((int) tempData[0] + 1, (int) tempData[1] - 1/2 - tempCenterY, 1, 1);
            }
        }
        else
        {
            ...
            for (double tempCoordinateX = tempCenterX - tempLeftRadious; tempCoordinateX <= tempCenterY + tempLeftRadious; tempCoordinateX += 0.001)
            {
                ...
                context.strokeOval((int) tempCoordinateX + 1, (int) (tempCenterY + tempCoordinateY - 1/2), 1, 1);
                context.strokeOval((int) tempCoordinateX + 1, (int) (tempCenterY - tempCoordinateY - 1/2), 1, 1);
            }
        }
    }
