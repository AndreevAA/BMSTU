...
public class CanvasOperations extends GraphicalObject
{
    ...
    static public List <GraphicalObject> addLineWithPointToObjects(double xMouseClickedPos, double yMouseClickedPos, List <GraphicalObject> objectList, List <GraphicalPoint> tempFigure, GraphicalPoint tempPoint, RectangleCutter mainRectangle){
        // Добавление точки
