...
public class BrezenchemsEquation extends GraphicalObject {
    ...
    public BrezenchemsEquation(double tempCenterX, double tempCenterY, double tempLeftRadious, double tempTopRadious, boolean isOval, Color tempColor)
    {
