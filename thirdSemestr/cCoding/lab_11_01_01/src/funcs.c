...
void convert_num_sys(long int value, char *string)
{
    int num = 0;
    long int value_buff = value;
...
// void str_plus_str(char *buffer, char *temp_str, int *add_cur)
// {
//     for (int temp_cur = 0; temp_cur < strlen(temp_str); temp_cur++, (*add_cur)++)
//         *(buffer + *(add_cur)) = *(temp_str + temp_cur);
// }
